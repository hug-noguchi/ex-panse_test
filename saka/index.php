		...
		<section class="menu_list container top_sec margin_sec">
			<div class=" element js-animation">
				...
				<article class="content menu3 independence_cource independence_cource_main">
					...
					<div class="domestic_point">
						<h3 class="section_h3">独立・開業コースの<br class="sp"><span class="left_sp">3つのポイント</span></h3>
						<div class="sub_text_box">
							<p>
						...
						<ol class="point_list">
							<li>
								<figure class="point_num">
									<img loading="lazy" decoding="async" src="../images/lp/point01_gold.svg" alt="point01" width="133" height="46">
								</figure>
								<div class="point_body">
									<h4><span class="emphasis">未経験</span>でも<br class="pc">大丈夫です！</h4>
									<figure>
										<img loading="lazy" decoding="async" src="../images/lp/point01-fig_v2.png" alt="未経験でも大丈夫です！" width="368" height="369">
									</figure>
							...
							<li>
								<figure class="point_num">
									<img loading="lazy" decoding="async" src="../images/lp/point02_gold.svg" alt="point02" width="133" height="46">
								</figure>
								<div class="point_body">
									<h4><span class="emphasis">卒業後も安心！</span><br class="sp">直営店舗勤務<br class="pc">研修、<br class="sp">加盟店制度もあります！</h4>
									<figure>
										<img loading="lazy" decoding="async" src="../images/lp/point02-fig_v2.png" alt="卒業後も安心！直営店舗勤務研修、加盟店制度もあります！" width="368" height="369">
									</figure>
							...
							<li>
								<figure class="point_num">
									<img loading="lazy" decoding="async" src="../images/lp/point03_gold.svg" alt="point03" width="133" height="46">
								</figure>
								<div class="point_body">
									<h4>11日間のインド留学で<br><span class="emphasis">本場の技術</span>を学べます！</h4>
									<figure>
										<img loading="lazy" decoding="async" src="../images/lp/point03-fig_v2.png" alt="11日間のインド留学で本場の技術を学べます！" width="368" height="369">
									</figure>
