        ...
        <div id="q2" class="txt_display">
          ...
          <div class="question_box">
            <div class="question_text">
              <img src="<?php bloginfo('url'); ?>/images/questionnaire/text02_v3.png" alt="アーユルヴェーダ"/>
            </div>
            <img src="<?php bloginfo('url'); ?>/images/questionnaire/image02.png" alt="アーユルヴェーダ"/>
            <div class="choose choose_list">
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire03_2/?q2_no_01" class="q2_01">基本的なことを学びたい！</a>
              </p>
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire03_2/?q2_no_02">開業まで学びたい！</a>
              </p>
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire03_2/?q2_no_03" class="q2_03">基礎も実技も幅広く学びたい！</a>
              </p>
            </div>
          </div>
        </div>
