  ...
  <div id="main">
    <div>
      <div id="question_area">
        <div>
          <img src="<?php bloginfo('url'); ?>/images/questionnaire/kv05_2.png" alt="エクスパンスセラピストで「手に職」を"/>
          <p class="thanks_text"><span>ご回答いただきありがとうございます！</span></p>
          <div class="choose choose05">
            <p>
              <a href="https://www.ex-panse.jp/basicmaster-courses_lp/?q4_03" target="_blank">講座を今すぐ確認する</a>
            </p>
          </div>
        </div>
      </div>
