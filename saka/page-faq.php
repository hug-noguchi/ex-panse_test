...
<main>
	...
	<div id="main_faq_img" class="content_main_faq_img faq_img"></div>
					...
					<dd class="accordion-box">
						<div class="faq_answer">
							...
							<div class="faq_answer_link">
								...
								<p>
									<a href="/menu_online/">オンライン受講のおすすめコースはこちら ></a>
								</p>
							</div>
						</div>
					</dd>
				...
				<dl>
					...
					<dd class="accordion-box">
						<div class="faq_answer">
							...
							<div class="faq_answer_link">
								<p>
									はい。開業セット（ベッド、タオル、オイル、備品等）が付いているコースのため、<br>通学中から物件決めや準備を進めれば、卒業後すぐにサロン開業が可能です。<br>未経験の場合は、3ヶ月から半年ほど練習を積み重ねながらサロン開業準備を進めていき、<br>万全の準備をしてからスタートすることをお勧めいたしております。
								</p>
								<p>
				...
				<dl>
					...
					<dd class="accordion-box">
						<div class="faq_answer">
							...
							<div class="faq_answer_link">
								<p>
									エクスパンス・アーユルヴェーダセラピスト協会のディプロマを発行しております。
								</p>
								<p>
