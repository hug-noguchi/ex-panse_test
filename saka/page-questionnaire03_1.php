        ...
        <div id="q3">
          ...
          <div class="question_box">
            <div class="question_text">
              <img src="<?php bloginfo('url'); ?>/images/questionnaire/text03_v2.png" alt="アーユルヴェーダ"/>
            </div>
            <img src="<?php bloginfo('url'); ?>/images/questionnaire/image03.png" alt="アーユルヴェーダ"/>
            <div class="choose choose_list">
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire04/?q3_yes_01">未経験でも大丈夫！</a>
              </p>
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire04/?q3_yes_02">スケジュール自由</a>
              </p>
              <p>
                <a href="<?php bloginfo('url'); ?>/questionnaire04/?q3_yes_03">短期間で学べる</a>
              </p>
            </div>
          </div>
        </div>
