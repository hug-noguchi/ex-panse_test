...
<!-- End Google Tag Manager -->
	...
	<meta name="description" content="<?php wp_title('｜' , true , 'right'); ?>アーユルヴェーダスクールです。東京・恵比寿駅徒歩１分。セラピストとして新たな技術や、これから独立をお考えの方への本場ケララのアーユルヴェーダスクール。実技・座学等、色々な養成講座コースがあります。独立支援コースやサロンの開業等サポートしております。東京・神奈川・千葉・茨城">
	<link rel="icon" href="<?php bloginfo('url'); ?>/images/icon.gif" type="image/jpeg" sizes="16x16">
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/include/css/lp.css">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
<script src="<?php bloginfo('url'); ?>/include/js/bootstrap.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.min.js" integrity="sha512-XtmMtDEcNz2j7ekrtHvOVR4iwwaD6o/FUJe6+Zq+HgcCsk3kj4uSQQR8weQ2QVj1o0Pk6PwYLohm206ZzNfubg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>


	<script src="<?php bloginfo('url'); ?>/include/js/lp.js"></script>
<!-- 	<script src="<?php bloginfo('url'); ?>/include/js/jquery.easing-1.3.pack.js"></script> -->
	<script src="<?php bloginfo('url'); ?>/include/js/ofi.min.js"></script>
...
<main>
	<div class="kv_box">
		<h1 class="kv">
			<picture>
				<img src="<?php bloginfo('url'); ?>/images/lp/kv_v3_sp.png" alt="エクスパンスセラピストへ" class="sp">
        <img src="<?php bloginfo('url'); ?>/images/lp/kv2_v3_sp.png" alt="エクスパンスセラピストへ" class="sp kv2">
				<img src="<?php bloginfo('url'); ?>/images/lp/kv_v3_pc.png" alt="エクスパンスセラピストへ" class="pc">
			</picture>
			<a href="#reserve" class="sp btn_kv_sp">
				<img src="<?php bloginfo('url'); ?>/images/lp/btn_kv_sp.png" alt="エクスパンスセラピストへ">
			</a>
			<a href="#reserve" class="pc btn_kv_pc">
				<img src="<?php bloginfo('url'); ?>/images/lp/btn_kv_pc.png" alt="エクスパンスセラピストへ">
			</a>
		</h1>
	</div>
	...
	<section class="cases js-animation is-show" id="cases">
		<h2 class="feature_lead">
			<picture>
				<source srcset="<?php bloginfo('url'); ?>/images/lp/lead_sp.png" media="(max-width: 640px)" />
				<img src="<?php bloginfo('url'); ?>/images/lp/lead_pc.png" alt="これまで約3000人の卒業生の輩出実績" width="1040" height="136">
			</picture>
		</h2>
			...
			<div id="ex" style="margin: 79px auto 0;">
				<div class="flow_box">
					<picture class="ex_pic">
						<source srcset="<?php bloginfo('url'); ?>/images/lp/ex.png" media="(max-width: 640px)">
						<img decoding="async" src="<?php bloginfo('url'); ?>/images/lp/ex.png" alt="開業事例">
					</picture>
					<div>
						...
						<picture class="pc" style="
							...
							left: 0;
						">
						<img decoding="async" src="<?php bloginfo('url'); ?>/images/lp/ex_bg1.png" alt="開業事例">
						</picture>
					</div>
					<div>
	...
	<div class="session js-animation">
		<picture>
			<source srcset="<?php bloginfo('url'); ?>/images/lp/session-lead_v2_sp.png" media="(max-width: 640px)">
			<img src="<?php bloginfo('url'); ?>/images/lp/session-lead_v2.png" alt="当日のお申し込みで総額50,000円相当の2大特典をプレゼント!!" width="671" height="90">
		</picture>
		<picture>
			<source srcset="<?php bloginfo('url'); ?>/images/lp/session-benefit_sp.png" media="(max-width: 640px)">
			<img src="<?php bloginfo('url'); ?>/images/lp/session-benefit.png" alt="特典" width="550" height="78">
		</picture>
		<a href="#reserve" id="cv_main_01">
			<picture>
				<source srcset="<?php bloginfo('url'); ?>/images/lp/session-btn_v2_sp.png" media="(max-width: 640px)">
				<img src="<?php bloginfo('url'); ?>/images/lp/session-btn_v2.png" alt="無料体験説明会ご予約" width="800" height="134">
			</picture>
		</a>
	</div>
		...
		<section>
			...
			<div class="w-container">
				<figure class="feature_pc">
					<img src="<?php bloginfo('url'); ?>/images/lp/feature-item.png" alt="独立・開業コースの特徴" width="1200" height="866">
				</figure>
				<ul class="feature_content">
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature00.png" alt="エクスパンス・アーユルヴェーダセラピスト協会が発行するディプロマ取得！" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature01.png" alt="すぐにスタートできる開業商材セット付き" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature02.png" alt="高レベルのサロン開業を目指せる" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature03.png" alt="創業15年、延べ5.5万人の実績を誇るエクスパンスの全てを学べる" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature05.png" alt="本場インドでのアーユルヴェーダ研修に参加することも可能" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature06.png" alt="エクスパンス加盟店制度あり" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature08.png" alt="完全マンツーマンで分かりやすい" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature09.png" alt="受講時の準備不要" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature10.png" alt="ライフスタイルに合わせて日程調整が可能" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature11.png" alt="将来に役立つ知識の習得" width="270" height="262">
					</li>
					<li>
						<img src="<?php bloginfo('url'); ?>/images/lp/feature12.png" alt="校長の話を直接聞ける" width="270" height="262">
					</li>
				</ul>
			</div>
		</section>
	...
	<section class="onayami w-container js-animation" id="onayami">
		...
		<div class="onayami_content">
			<picture>
				<source srcset="<?php bloginfo('url'); ?>/images/lp/onayami_sp.png" media="(max-width: 640px)">
				<img decoding="async" src="<?php bloginfo('url'); ?>/images/lp/onayami.png" alt="このようなお悩みありませんか？" width="1200" height="559">
			</picture>
		</div>
	</section>
			...
			<ol class="point_list">
				<li>
					<figure class="point_num">
						<img src="<?php bloginfo('url'); ?>/images/lp/point01.svg" alt="point01" width="133" height="46">
					</figure>
					<div class="point_body">
						<h4><span class="emphasis">未経験</span>でも<br>大丈夫！</h4>
						<figure>
							<img src="<?php bloginfo('url'); ?>/images/lp/point01-fig.png" alt="未経験でも大丈夫！" width="368" height="369">
						</figure>
				...
				<li>
					<figure class="point_num">
						<img src="<?php bloginfo('url'); ?>/images/lp/point02.svg" alt="point02" width="133" height="46">
					</figure>
					<div class="point_body">
						<h4><span class="emphasis">卒業後も安心！</span>直営店舗勤務<br>研修、加盟店制度もあり！</h4>
						<figure>
							<img src="<?php bloginfo('url'); ?>/images/lp/point03-fig.png" alt="卒業後も安心！直営店舗勤務研修、加盟店制度もあり！" width="368" height="369">
						</figure>
				...
				<li>
					<figure class="point_num">
						<img src="<?php bloginfo('url'); ?>/images/lp/point03.svg" alt="point03" width="133" height="46">
					</figure>
					<div class="point_body">
						<h4>11日間のインド留学で<br><span class="emphasis">本場の技術</span>を学べる！</h4>
						<figure>
							<img src="<?php bloginfo('url'); ?>/images/lp/point02-fig.png" alt="11日間のインド留学で本場の技術を学べる！" width="368" height="369">
						</figure>
	...
	<section class="voice js-animation" id="voice">
				...
				<div class="voice-item">
					<div class="voice-item_inner">
						...
						<div class="voice-item_qa02">
							...
							<div style="width: 38%;">
								<img src="https://www.ex-panse.jp/images/lp/voice_tahanashi_03.png" alt="" class="pc">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="voice-item_inner">
						...
						<div>
							...
							<div class="voice_hagiwara_image" style="z-index: 1;position: relative;margin: 60px auto;width: 80%;">
								<img src="https://www.ex-panse.jp/images/lp/voice_hagiwara_02.png" alt="" class="pc">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="voice_content kiso_course">
			...
			<div class="flow_box">
				...
				<ol class="flow_list">
					<li>
						<div class="flow_item">
							<figure>
								<img src="<?php bloginfo('url'); ?>/images/lp/step01.svg" alt="step01" width="138" height="80">
							</figure>
					...
					<li>
						<div class="flow_item">
							<figure>
								<img src="<?php bloginfo('url'); ?>/images/lp/step02.svg" alt="step02" width="138" height="80">
							</figure>
					...
					<li>
						<div class="flow_item">
							<figure>
								<img src="<?php bloginfo('url'); ?>/images/lp/step03.svg" alt="step03" width="138" height="80">
							</figure>
					...
					<li>
						<div class="flow_item">
							<figure>
								<img src="<?php bloginfo('url'); ?>/images/lp/step04.svg" alt="step04" width="138" height="80">
							</figure>
					...
					<li>
						<div class="flow_item">
							<figure>
								<img src="<?php bloginfo('url'); ?>/images/lp/step05.svg" alt="step05" width="138" height="80">
							</figure>
	...
	<section class="course js-animation">
		<div class="w-container">
			...
			<div class="course_content">
				<figure>
					<img src="<?php bloginfo('url'); ?>/images/lp/course.jpg" alt="" width="870" height="580">
				</figure>
	...
	<section class="curriculum js-animation" id="curriculum">
		<div class="w-container">
			...
			<div class="curriculum_box">
				<h4 class="curriculum_heading"><img src="<?php bloginfo('url'); ?>/images/lp/notebook.svg" alt="座学" width="46" height="46">座学</h4>
				<div class="curriculum_body">
					<ol class="curriculum_list">
						<li>
							<div class="row">
								<figure>
									<img src="<?php bloginfo('url'); ?>/images/lp/menu01.jpg" alt="「生命の科学」アーユルヴェーダとは" width="120" height="120">
								</figure>
						...
						<li>
							<div class="row">
								<figure>
									<img src="<?php bloginfo('url'); ?>/images/lp/menu02.jpg" alt="アーユルヴェーダ健康法" width="120" height="120">
								</figure>
								<h5>②アーユルヴェーダ健康法</h5>
							</div>
							<div class="curriculum_content">
			...
			<div class="curriculum_box skill">
				<h4 class="curriculum_heading">
					<img src="<?php bloginfo('url'); ?>/images/lp/hand.svg" alt="実技" width="46" height="46">実技
				</h4>
				<div class="curriculum_body">
					<ol class="curriculum_list">
						<li>
							<div class="row">
								<figure>
									<img src="<?php bloginfo('url'); ?>/images/lp/skill01.jpg" alt="アヴィヤンガ（ボディトリートメント）" width="120" height="120">
								</figure>
						...
						<li>
							<div class="row">
								<figure>
									<img src="<?php bloginfo('url'); ?>/images/lp/skill02.jpg" alt="マルマ療法" width="120" height="120">
								</figure>
								<h5>②マルマ療法</h5>
							</div>
							<div class="curriculum_content">
						...
						<li>
							<div class="row">
								<figure>
									<img src="<?php bloginfo('url'); ?>/images/lp/skill03.jpg" alt="シローヴィヤンガ（ヘッドトリートメント）" width="120" height="120">
								</figure>
						...
						<li>
							<div class="row">
								<figure>
									<img src="<?php bloginfo('url'); ?>/images/lp/skill04.jpg" alt="シローダーラ" width="120" height="120">
								</figure>
								<h5>④シローダーラ</h5>
							</div>
							<div class="curriculum_content">
						...
						<li>
							<div class="row">
								<figure>
									<img src="<?php bloginfo('url'); ?>/images/lp/skill05.jpg" alt="アーユルヴェーダ式　鼻・耳・口・目のケア方法" width="120" height="120">
								</figure>
						...
						<li>
							<div class="row">
								<figure>
									<img src="<?php bloginfo('url'); ?>/images/lp/skill06.jpg" alt="フェイシャルトリートメント" width="120" height="120">
								</figure>
								<h5>⑥フェイシャルトリートメント</h5>
							</div>
							<div class="curriculum_content">
						...
						<li>
							<div class="row">
								<figure>
									<img src="<?php bloginfo('url'); ?>/images/lp/skill07.jpg" alt="確認テスト・まとめ" width="120" height="120">
								</figure>
								<h5>⑦確認テスト・まとめ</h5>
	...
	<section class="message js-animation" id="message">
		<div class="w-container">
			...
			<div class="message_content">
				<figure>
					<img src="<?php bloginfo('url'); ?>/images/lp/izawa.jpg" alt="井澤 美夏" width="360" height="480">
				</figure>
	...
	<section class="reserve js-animation" id="reserve">
		<div class="reserve_inner">
			...
			<div class="reserve_form">
				<?php echo do_shortcode( '[mwform_formkey key="890"]' ); ?>
			</div>
		</div>
	</section>
		...
		<div class="w-container">
			...
			<div class="company_detail ginza">
				<div class="company_body">
					<h4>銀座本校</h4>
					<ul>
						<li><img src="<?php bloginfo('url'); ?>/images/lp/map.svg" alt="map" width="11" height="15" class="map">東京都中央区銀座7-9-11 モンブラン銀座ビル8階</li>
						<li><img src="<?php bloginfo('url'); ?>/images/lp/dial.svg" alt="tel" width="15" height="10">03-6263-9501</li>
					</ul>
				</div>
			...
			<div class="company_list">
				<div class="company_detail">
					<div class="company_body">
						<h4>恵比寿校</h4>
						<ul>
							<li><img src="<?php bloginfo('url'); ?>/images/lp/map.svg" alt="map" width="11" height="15" class="map">東京都渋谷区恵比寿4-3-1 クイズ恵比寿3F-O</li>
							<li><img src="<?php bloginfo('url'); ?>/images/lp/dial.svg" alt="tel" width="15" height="10">03-3442-6656</li>
						</ul>
					</div>
				...
				<div class="company_detail">
					<div class="company_body">
						<h4>池袋校</h4>
						<ul>
							<li><img src="<?php bloginfo('url'); ?>/images/lp/map.svg" alt="map" width="11" height="15" class="map">東京都豊島区南池袋1-17-2 南池袋I-Nビル8F</li>
							<li><img src="<?php bloginfo('url'); ?>/images/lp/dial.svg" alt="tel" width="15" height="10">0800-800-1787（フリーダイヤル）</li>
						</ul>
					</div>
					<div class="company_map02">
				...
				<div class="company_detail">
					<div class="company_body">
						<h4>渋谷校</h4>
						<ul>
							<li><img src="<?php bloginfo('url'); ?>/images/lp/map.svg" alt="map" width="11" height="15" class="map">東京都渋谷区宇田川町33-1　グランド東京渋谷ビル6階</li>
							<li><img src="<?php bloginfo('url'); ?>/images/lp/dial.svg" alt="tel" width="15" height="10">03-5422-3110</li>
						</ul>
					</div>
					<div class="company_map02">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6483.319668100927!2d139.68838727770992!3d35.6607517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188d332ac1031f%3A0x58c0b57c4f7c7a85!2z44Ki44O844Om44Or44O044Kn44O844OA44K144Ot44OzIEV4cGFuc2UuLiDmuIvosLflupfjgJDjgqjjgq_jgrnjg5Hjg7PjgrnjgJE!5e0!3m2!1sja!2sjp!4v1695084068376!5m2!1sja!2sjp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="fixedBanner">
		<a href="#reserve" id="cv_bnr">
			<picture>
				<source srcset="<?php bloginfo('url'); ?>/images/lp/fixed-banner_v2_sp.png" media="(max-width: 640px)" />
				<img src="<?php bloginfo('url'); ?>/images/lp/fixed-banner_v3_pc.png" alt="無料体験説明会ご予約" />
			</picture>
		</a>
	</div>
</main>
