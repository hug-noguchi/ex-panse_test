	<footer>
		...
		<div class="banner">
			<ul>
				<li><a href="#" class="btn_fade"><picture><source type="image/webp" srcset="<?php bloginfo('url'); ?>/images/footer_banner_ec.webp"><img src="<?php bloginfo('url'); ?>/images/footer_banner_ec.jpg"></picture></a></li>
			</ul>
		</div>
		...
		<article>
			<div class="address">
				...
				一般社団法人エクスパンス・アーユルヴェーダセラピスト協会</p>
				<p>〒104-0061<br>
				東京都中央区銀座7-9-11 モンブラン銀座ビル8階</p>
				
				<address>Copyright (C) 2013- R&amp;M Co.,Ltd. All Rights Reserved.</address>
			</div>
			
			<ul class="footer_nav">
				<li><a href="<?php bloginfo('url'); ?>/concept/">スクールの特徴</a></li>
			...
			<ul class="footer_nav">
				<li><a href="<?php bloginfo('url'); ?>/teacher/">講師紹介</a></li>
				<li><a href="<?php bloginfo('url'); ?>/access/">アクセス</a></li>
				<li><a href="<?php bloginfo('url'); ?>/diagnose/">アーユルヴェーダ体質診断</a></li>
				<li><a href="<?php bloginfo('url'); ?>/info/">インフォメーション</a></li>
				<li><a href="<?php bloginfo('url'); ?>/blog/">ブログ</a></li>
				<li><a href="<?php bloginfo('url'); ?>/review/">受講されたお客様の声</a></li>
	...
	<div class="following">
		<p class="briefing"><a href="<?php bloginfo('url'); ?>/contact#briefing_link" class="btn_fade"><i class="far fa-file"></i>無料体験説明会</a></p>
